...
| 🖥️&nbsp;**Proxmox&nbsp;UI&nbsp;Custom** | Customizações de interface para Proxmox VE — observadores, temas, auto-realm e scripts de automação | ![Python](https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white) ![JavaScript](https://img.shields.io/badge/JavaScript-F7DF1E?style=flat-square&logo=javascript&logoColor=black) |
| 🔒&nbsp;**Hardenização&nbsp;Linux** | Guias e scripts de hardening para servidores Linux — CIS Benchmark, SSH, firewall e auditoria | ![Shell](https://img.shields.io/badge/Shell-121011?style=flat-square&logo=gnu-bash&logoColor=white) ![Linux](https://img.shields.io/badge/Linux-FCC624?style=flat-square&logo=linux&logoColor=black) |
